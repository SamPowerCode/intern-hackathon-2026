...
s5_payload = {
    ...
    "labels": ["Emergency code 1", "Emergency code 2", "Emergency code 3"],
    "toolType": "sql",
...
Lock codes shown to participants: `{s1_codes[0]}`, `{s1_codes[1]}`, `{s1_codes[2]}`

**Python solution:**
```python
KEYLOG = "fjk39dls02pqzxcv8nm1"
CODES  = [{s1_codes[0]}, {s1_codes[1]}, {s1_codes[2]}]
